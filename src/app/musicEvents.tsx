import { MusicEvent } from "./components/MapsApp";

const eventsData: MusicEvent[] = [
  {
    id: 1,
    title: "Elvis Presley's First Television Appearance",
    description:
  ...
  {
    id: 2,
    title: "The Beatles' First U.S. Television Performance on The Ed Sullivan Show",
    description:
  ...
  {
    id: 4,
    title: "Michael Jackson's Moonwalk",
    description:
  ...
  {
    id: 7,
    title: "Queen's Live Aid Performance",
    description:
  ...
  {
    id: 8,
    title: "The Beatles Release 'Sgt. Pepper's Lonely Hearts Club Band'",
    description:
  ...
  {
    id: 9,
    title: "Madonna's 'Like a Virgin' Album Release",
    description:
  ...
  {
    id: 10,
    title: "The Rolling Stones' Altamont Free Concert",
    description:
